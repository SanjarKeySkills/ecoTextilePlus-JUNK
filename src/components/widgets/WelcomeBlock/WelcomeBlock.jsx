        ...
        <div className={styles.welcome}>
            ...
            {/* <div className={styles.annotationBox}>
                <p className={styles.annotation}>
                    Данный проект разрабатывается компанией ОсОО "Дукастомс",
                    которая является лидером в области переработки отходов
                    швейной отрасли. Мы стремимся предложить инновационные и
                    экологически безопасные решения для переработки текстильных
                    отходов, превращая их в полезные материалы, которые могут
                    быть использованы повторно. Этот проект направлен на
                    улучшение экологической ситуации, снижение смога в городах и
