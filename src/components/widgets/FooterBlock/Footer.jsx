        ...
        <div className={styles.footer}>
            <div className={styles.footerWrapper}>
                ...
                <div className={styles.footerInfo}>
                    ...
                    <p>
                        ОсОО "Дукастомс" является профессиональной организацией,
                        объединяющей квалифицированных экспертов в области
                        переработки отходов швейной отрасли, устойчивого
